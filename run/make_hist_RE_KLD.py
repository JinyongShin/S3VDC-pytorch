...
plt.hist(n_re,label=n_la,color=c_lst,range=(0,1000),bins=20,stacked=True)
plt.hist(an_re_c,label='Anomaly',histtype='step',color='r',linewidth=2,range=(0,1000),bins=20)
plt.yscale('log')
plt.legend()
...
plt.hist(n_kld,label=n_la,color=c_lst,range=(0,50),bins=10,stacked=True)
plt.hist(an_kld_c,label='Anomaly',histtype='step',color='r',linewidth=2,range=(0,50),bins=10)
plt.yscale('log')
plt.legend(loc='upper right')
plt.xlabel('KL-Divergence')
plt.ylabel('Number of events / bin')
#plt.show()
plt.savefig(args.indir + '/stacked_kld.png')
plt.close()
...
plt.hist(n_kld,label='normal',color='royalblue',range=(0,50),bins=10)
plt.hist(an_kld,label='Anormaly',histtype='step',color='r',linewidth=2,range=(0,50),bins=10)
plt.legend()
plt.yscale('log')
...
plt.ylabel('Number of events / bin')
#plt.show()
plt.savefig(args.indir + '/kld_hist.png')
plt.close()

plt.hist(n_re,label='normal',color='royalblue',range=(0,1000),bins=20)
plt.hist(an_re,label='Anomaly',histtype='step',color='r',linewidth=2,range=(0,1000),bins=20)
plt.legend()
plt.yscale('log')
